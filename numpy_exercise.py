...
print("The total sales is $" + str(salesArray.sum()))
...
boolArray = salesArray >= 100
highPurchases = salesArray[boolArray]

print("Sales greater than or equal to $100 include:", highPurchases)
print()
